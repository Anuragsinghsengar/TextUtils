...
function App() {
  ...
  const DarkMode = () => {
    if(mode === 'dark'){
      ...
      document.title = 'TextUtils2- A wonderful text analyzer[Dark Mode]'
  ...
  const BlueMode = () => {
    if(mode == 'blue'){
      ...
      document.title = 'TextUtils2- A wonderful text analyzer[Blue Mode]'
      // setCurrentMode('Enable Dark Mode');
    }
  }
  const LightMode = () => {
    if(mode == 'light'){
      ...
      showAlert('Light Mode has been enabled','success');
      document.title = 'TextUtils2- A wonderful text analyzer[Light Mode]'
      // setCurrentMode('Enable Dark Mode');
    }
  }
  const GreenMode = () => {
    if(mode == 'green'){
      ...
      document.title = 'TextUtils2- A wonderful text analyzer[Green Mode]'
      // setCurrentMode('Enable Dark Mode');
    }
  }
  const RedMode = () => {
    if(mode == 'red'){
      ...
      document.title = 'TextUtils2- A wonderful text analyzer[Red Mode]'
      // setCurrentMode('Enable Dark Mode');
    }
  }
  const YellowMode = () => {
    if(mode == 'yellow'){
      ...
      document.title = 'TextUtils2- A wonderful text analyzer[Yellow Mode]'
      // setCurrentMode('Enable Dark Mode');
    }
  }
  return (
